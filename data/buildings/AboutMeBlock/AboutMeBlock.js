export const AboutMeBlock = {
    ...
    wordArrays: [
        ...
        [],
        ['At 21, I decided to leave school to pursue my other great passion, cooking.  I spent the next 18 years following that dream, working as a chef, then business owner.  I loved my time in the service industry, but I always wondered about the Computer Science path I left.'],
        [],
        ...
        [],
        ['I spent the summer of 2020 teaching myself Java and Python. I loved spending the days working out problems, and learning new frameworks.  I built a 2D side-scrolling game using PyGame.  I made an API server that webscrapped from a local paper’s website.  I loved building these apps, and I loved learning these new skills.'],
        [],
